"""testfirst_18354 URL Configuration
...
admin.site.site_header = "TestFirst"
admin.site.site_title = "TestFirst Admin Portal"
admin.site.index_title = "TestFirst Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="TestFirst API",
        default_version="v1",
        description="API documentation for TestFirst App",
    ),
    public=True,
